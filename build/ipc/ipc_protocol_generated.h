...
typedef enum ipc_command
{
	...
	IPC_COMPOSITOR_SET_PERFORMANCE_LEVEL,
	...
	IPC_COMPOSITOR_CREATE_PASSTHROUGH,
	IPC_COMPOSITOR_CREATE_PASSTHROUGH_LAYER,
	IPC_COMPOSITOR_DESTROY_PASSTHROUGH,
...
ipc_cmd_to_str(ipc_command_t id)
{
	...
	case IPC_SYSTEM_GET_PROPERTIES: return "IPC_SYSTEM_GET_PROPERTIES";
	...
	case IPC_COMPOSITOR_SET_PERFORMANCE_LEVEL: return "IPC_COMPOSITOR_SET_PERFORMANCE_LEVEL";
	...
	case IPC_COMPOSITOR_CREATE_PASSTHROUGH: return "IPC_COMPOSITOR_CREATE_PASSTHROUGH";
	case IPC_COMPOSITOR_CREATE_PASSTHROUGH_LAYER: return "IPC_COMPOSITOR_CREATE_PASSTHROUGH_LAYER";
	case IPC_COMPOSITOR_DESTROY_PASSTHROUGH: return "IPC_COMPOSITOR_DESTROY_PASSTHROUGH";
	...
	case IPC_DEVICE_GET_FACE_TRACKING: return "IPC_DEVICE_GET_FACE_TRACKING";
...
struct ipc_system_get_properties_reply
{
	xrt_result_t result;
...
struct ipc_compositor_set_performance_level_msg
{
	enum ipc_command cmd;
...
struct ipc_compositor_create_passthrough_msg
{
	enum ipc_command cmd;
	struct xrt_passthrough_create_info info;
};

struct ipc_compositor_create_passthrough_layer_msg
{
	enum ipc_command cmd;
...
struct ipc_device_get_face_tracking_msg
{
	enum ipc_command cmd;
	uint32_t id;
...
struct ipc_device_get_face_tracking_reply
{
	xrt_result_t result;
	struct xrt_facial_expression_set value;
};
#pragma pack (pop)
