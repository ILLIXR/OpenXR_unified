...
set(OUT_FILENAME openxr_test.json)
set(CONFIGURE_OUTPUT_FILE /home/friedel/devel/OpenXR_unified/build/openxr_app/openxr_test.json)
set(IS_INSTALL ON)
set(MANIFEST_DESCRIPTION "OpenXR runtime manifest")
set(TARGET openxr_test)
# Target install dir relative to install prefix
set(RELATIVE_TARGET_DIR /home/friedel/oxr/lib)
# Target so/dll filename
set(TARGET_FILENAME libopenxr_test.so)
# The relative path from the manifest dir to the library. Optional.
set(TARGET_DIR_RELATIVE_TO_MANIFEST
    )
# Config option
set(ABSOLUTE_TARGET_PATH FALSE)
